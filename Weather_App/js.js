window.addEventListener('load', ()=>{
    ...
    if(navigator.geolocation){
        navigator.geolocation.getCurrentPosition(location =>{
            ...
            const zone = `http://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=${key}&q=${latitude}%2C${longitude}&details=true&toplevel=true`
            const current = `http://dataservice.accuweather.com/currentconditions/v1/178541?apikey=${key}&details=true`
